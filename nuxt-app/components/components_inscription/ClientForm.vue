                  ...
                  <form v-if="this.$route.query.profil === 'client'" @submit.prevent="onSubmit" class="space-y-4 md:space-y-6" action="#">
                    ...
                    <div class="grid grid-cols-2 gap-2">
                      <div>
                          ...
                          <input id="firstname" v-model="clientForm.firstname" name="firstname" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Firstname" required="">
                      </div>
                      <div>
                          <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900">Lastname</label>
                          <input id="lastname" v-model="clientForm.lastname" name="lastname" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Lastname" required="">
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div>
                          ...
                          <input id="email_sponso" v-model="clientForm.email_sponsor" type="email" name="email_sponso" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="nom_sponso@email.com" required="">
                      </div>
                      </div>
